...
class MyTestCase(unittest.TestCase):
    def test_all(self):
        ...
        print("title------------------------")
        pprint.pprint(parser.get_title())
        print("summary----------------------")
        pprint.pprint(parser.get_summary())
        print("share,like-------------------")
        pprint.pprint(parser.get_share_like_count())
        print("preview-------------------")
        pprint.pprint(parser.get_preview_count(content))
        print("tags-------------------")
        pprint.pprint(parser.get_tags())
        print("basic-info-------------------")
        pprint.pprint(parser.get_basic_info())
        print("reference--------------------")
        pprint.pprint(parser.get_reference())
        print("main-------------------")
